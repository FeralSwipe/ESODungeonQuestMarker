...
local translations = {
    en = {
        ...
        protectResearchLegendary = "Protect legendary items",
        protectResearchLegendaryTip = "Do not let PAWorker auto-research gold legendary items.",
        protectResearchMythic = "Protect mythic items",
    ...
    ru = {
        ...
        protectResearchCurrentMeta = "Защищать актуальные метовые сеты",
        ...
        protectResearchLegacyMeta = "Защищать устаревшие метовые сеты",
